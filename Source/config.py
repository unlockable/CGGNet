...
adv_gen_path = pretrain_root + 'gen_ADV_pretrain_{}_{}_sl{}_sn{}.pt'.format(run_model, model_type,
...
def init_param(opt):
    global run_model, model_type, loss_type, CUDA, device, data_shuffle, samples_num, vocab_size, \
        ...
        use_nll_oracle, use_nll_gen, use_nll_div, use_bleu, use_self_bleu, use_clas_acc, use_ppl, vul_path
